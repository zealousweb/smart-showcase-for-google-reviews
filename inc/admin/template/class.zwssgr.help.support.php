...
?>
<div class="wrap zwssgr-help-wrapper">
	<h1><?php esc_html_e( 'Help & Support', 'smart-showcase-for-google-reviews' ); ?></h1>

	<div class="zwssgr-help-page">
		<p class="zwssgr-page-subtitle">
			<?php esc_html_e( 'If you’re experiencing issues or have questions about features, our support team is here to help. Submit a ticket, browse our knowledge base, or check the FAQs to find a fast solution.', 'smart-showcase-for-google-reviews' ); ?>
		</p>

		<div class="zwssgr-help-top-grid">
			<div class="zwssgr-help-card">
				...
				<h2 class="zwssgr-help-card-title"><?php esc_html_e( 'Complete Plugin User Guide', 'smart-showcase-for-google-reviews' ); ?></h2>
				<p class="zwssgr-help-card-text">
					<?php esc_html_e( 'Browse helpful resources or reach out for support. Get quick solutions to keep things running smoothly.', 'smart-showcase-for-google-reviews' ); ?>
				</p>
				<div class="zwssgr-help-card-footer">
					<a class="zwssgr-primary-btn" href="https://store.zealousweb.com/documentation/wordpress-plugins/smart-showcase-for-google-reviews" target="_blank" rel="noopener noreferrer">
						<?php esc_html_e( 'View Plugin Guide', 'smart-showcase-for-google-reviews' ); ?>
						<span class="zwssgr-primary-btn-icon" aria-hidden="true">
			...
			<div class="zwssgr-help-card">
				...
				<h2 class="zwssgr-help-card-title"><?php esc_html_e( 'Experiencing an issue or have a suggestion?', 'smart-showcase-for-google-reviews' ); ?></h2>
				<p class="zwssgr-help-card-text">
					<?php esc_html_e( 'Submit a ticket to report problems, ask questions, or share feature ideas.', 'smart-showcase-for-google-reviews' ); ?>
				</p>
				<div class="zwssgr-help-card-footer">
					<a class="zwssgr-primary-btn" href="https://support.zealousweb.com/portal/en/home" target="_blank" rel="noopener noreferrer">
						<?php esc_html_e( 'Open Support Ticket', 'smart-showcase-for-google-reviews' ); ?>
						<span class="zwssgr-primary-btn-icon" aria-hidden="true">
							<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
								<path fill-rule="evenodd" clip-rule="evenodd" d="M12.71 5.88542L0.322265 5.88542C0.143229 5.90251 -3.18009e-07 6.05794 -3.09827e-07 6.24512L-2.72974e-07 7.08822C-2.64294e-07 7.28678 0.161133 7.44954 0.356445 7.44954L10.5176 7.44954L5.90169 12.1191C5.861 12.1606 5.83171 12.2095 5.81543 12.2607C5.77311 12.3869 5.80241 12.5309 5.90169 12.631L6.49089 13.2275C6.63086 13.3683 6.8571 13.3683 6.99707 13.2275L13.2292 6.9222C13.3675 6.78141 13.3675 6.55192 13.2292 6.41113L12.71 5.88542ZM7.00297 0.105591L11.0166 4.16646L8.82579 4.16646L5.90759 1.21399C5.76762 1.07239 5.76762 0.84371 5.90759 0.702108L6.49678 0.105591C6.63676 -0.0351966 6.863 -0.0351966 7.00297 0.105591Z" fill="white" />
							</svg>
			...
			<div class="zwssgr-help-card">
				...
				<h2 class="zwssgr-help-card-title"><?php esc_html_e( 'Subscribe to our newsletter', 'smart-showcase-for-google-reviews' ); ?></h2>
				<p class="zwssgr-help-card-text">
					<?php esc_html_e( 'Sign up for our newsletter and receive exclusive discounts and promotions.', 'smart-showcase-for-google-reviews' ); ?>
				</p>
		...
		<div class="zwssgr-help-bottom-grid">
			<?php if ( ! empty( $zwssgr_help_blog_posts ) ) : ?>
                <div class="zwssgr-help-card zwssgr-help-card-wide">
                    ...
                    <h2 class="zwssgr-help-card-title">
                        <?php esc_html_e( 'Related Blog', 'smart-showcase-for-google-reviews' ); ?>
                    </h2>

                    <p class="zwssgr-help-card-text">
                        <?php esc_html_e( 'Read our latest blog posts for deeper insights.', 'smart-showcase-for-google-reviews' ); ?>
                    </p>
			...
			<div class="zwssgr-help-card zwssgr-help-card-wide">
				...
				<div class="zwssgr-help-faq-list" role="list">
					<?php if ( ! empty( $zwssgr_help_faqs ) ) : ?>
						...
						<?php endforeach; ?>
					<?php else : ?>
						<p class="zwssgr-help-card-text zwssgr-help-remote-empty">
							<?php esc_html_e( 'No FAQs are available at the moment. Please try again later or contact support.', 'smart-showcase-for-google-reviews' ); ?>
						</p>
					<?php endif; ?>
				</div>
			</div>
...
(function () {
	document.addEventListener('DOMContentLoaded', function () {
		document.querySelectorAll('.zwssgr-help-faq-question').forEach(function (btn) {
			btn.addEventListener('click', function () {
				var item = btn.closest('.zwssgr-help-faq-item');
				if (!item) {
					return;
				}
