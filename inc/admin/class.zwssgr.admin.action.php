...
if ( !class_exists( 'ZWSSGR_Admin_Action' ) ){
	...
	class ZWSSGR_Admin_Action {
		...
		function zwssgr_filter_manage_data_posts_columns($zwssgr_columns) {
			...
			$zwssgr_columns['zwssgr_pin'] = __('Pin', 'smart-showcase-for-google-reviews');
		...
		function zwssgr_render_hide_column_content( $zwssgr_column, $zwssgr_post_id ) {
			...
			if ($zwssgr_column === 'zwssgr_pin') {
				$zwssgr_is_pinned = get_post_meta($zwssgr_post_id, 'zwssgr_is_pinned', true);
				$icon_url = $zwssgr_is_pinned ? ZWSSGR_URL . '/assets/images/pin.svg' : ZWSSGR_URL . '/assets/images/unpin.svg';
		
				echo '<a href="#" class="zwssgr-toggle-pin" data-post-id="' . esc_attr($zwssgr_post_id) . '">';
				echo '<img src="' . esc_url($icon_url) . '" class="zwssgr-pin-icon" alt="' . ($zwssgr_is_pinned ? 'Pinned' : 'Unpinned') . '" />';
				echo '</a>';
			}
		}
		...
		function zwssgr_toggle_visibility() {
			...
			if (isset($_POST['action_type']) && $_POST['action_type'] === 'pin_toggle') {
				...
				// Toggle pin status
				if ($zwssgr_is_pinned) {
					// Unpin if it is already pinned
					update_post_meta($zwssgr_post_id, 'zwssgr_is_pinned',0);
					$zwssgr_new_state = 'unpinned';
					$zwssgr_icon = ZWSSGR_URL . '/assets/images/unpin.svg';
				} else {
					// Pin if it is not pinned
					update_post_meta($zwssgr_post_id, 'zwssgr_is_pinned', 1);
					$zwssgr_new_state = 'pinned';
					$zwssgr_icon = ZWSSGR_URL . '/assets/images/pin.svg';
				}
			
				// Send JSON response with updated pin state and icon
				wp_send_json_success(array(
					'icon' => $zwssgr_icon,
					'state' => $zwssgr_new_state // Send the current state (pinned/unpinned)
				));
			}
		...
		function zwssgr_widget_configurator_callback() 
		{
			...
			if ($latest_zwssgr_reviews->have_posts()) {
				while($latest_zwssgr_reviews->have_posts()) {
						...
						<div class="zwssgr-slide-item swiper-slide">
							<div class="zwssgr-list-inner">
								...
								( !empty($zwssgr_trimmed_content) ? '<p class="zwssgr-content">' . esc_html($zwssgr_trimmed_content) . ($zwssgr_is_trimmed 
									? ' <a class="toggle-content zwssgr-toggle-content" data-full-text="' . esc_attr($zwssgr_review_comment) . '">' . esc_html($this->zwssgr_translate_read_more($zwssgr_language)) . '</a>' 
									: '') . '</p>' : '' ). '
							</div>
						</div>';
					...
					$zwssgr_slider_item2 = '
						<div class="zwssgr-slide-item swiper-slide">
							<div class="zwssgr-list-inner">
								...
								' . ( !empty($zwssgr_trimmed_content) ? '<p class="zwssgr-content">' . esc_html($zwssgr_trimmed_content) . ($zwssgr_is_trimmed ? ' <a class="toggle-content zwssgr-toggle-content" data-full-text="' . esc_attr($zwssgr_review_comment) . '">' . esc_html($this->zwssgr_translate_read_more($zwssgr_language)) . '</a>': '') . '</p>' : '' ) . '
								<div class="zwssgr-slide-wrap">
									<div class="zwssgr-profile">
										'.(file_exists($zwssgr_gmb_reviewer_image_path) ? '<img src="' . esc_url($zwssgr_gmb_reviewer_image_uri) . '" class="fallback-user-dp" alt="'. esc_html($zwssgr_reviewer_name).'">' : '<img src="' . $zwssgr_plugin_dir_path . 'assets/images/fallback-user-dp.png" alt="'. esc_html($zwssgr_reviewer_name).'">').'
									</div>
						...
						<div class="zwssgr-slide-item">
							<div class="zwssgr-grid-inner">
								<div class="zwssgr-slide-wrap">
									...
									? ' <a class="toggle-content zwssgr-toggle-content" data-full-text="' . esc_attr($zwssgr_review_comment) . '">' . esc_html($this->zwssgr_translate_read_more($zwssgr_language)) . '</a>' : '') . '</div></p>' : '' ) . '
								</div>
							</div>
						</div>';
					...
					$zwssgr_slider_content7[] = $zwssgr_slider_item7;
					$zwssgr_slider_content8[] = $zwssgr_slider_item8;
					...
					$zwssgr_grid_content6[] = $zwssgr_grid_item6;
					$zwssgr_grid_content7[] = $zwssgr_grid_item7;

					$zwssgr_popup_content1[] = $zwssgr_popup_item1;
					$zwssgr_popup_content2[] = $zwssgr_popup_item2;
					$zwssgr_popup_content3[] = $zwssgr_popup_item3;
			...
			$zwssgr_slider_content7 = isset($zwssgr_slider_content7) && !empty($zwssgr_slider_content7) ? implode('', (array) $zwssgr_slider_content7) : '';
			$zwssgr_slider_content8 = isset($zwssgr_slider_content8) && !empty($zwssgr_slider_content8) ? implode('', (array) $zwssgr_slider_content8) : '';
			...
			$zwssgr_grid_content6 = isset($zwssgr_grid_content6) && !empty($zwssgr_grid_content6) ? implode('', (array) $zwssgr_grid_content6) : '';
			$zwssgr_grid_content7 = isset($zwssgr_grid_content7) && !empty($zwssgr_grid_content7) ? implode('', (array) $zwssgr_grid_content7) : '';
			...
			$zwssgr_popup_content3 = isset($zwssgr_popup_content3) && !empty($zwssgr_popup_content3) ? implode('', (array) $zwssgr_popup_content3) : '';
			...
			$zwssgr_options = [
				...
				',
					...
					'<div class="zwssgr-slider zwssgr-slider7" id="zwssgr-slider7">
						<div class="zwssgr-slider-7 swiper">
							<div class="swiper-wrapper">
								' . (($zwssgr_post_count > 0) ? $zwssgr_slider_content7  : '<p class="zwssgr-no-found-message">'.esc_html__('No reviews found for the selected ratings', 'smart-showcase-for-google-reviews').'</p>') . '
							</div>
						</div>
						<div class="swiper-button-next zwssgr-swiper-button-next"></div>
						<div class="swiper-button-prev zwssgr-swiper-button-prev"></div>
					</div>',
					'<div class="zwssgr-slider zwssgr-slider8" id="zwssgr-slider8">
						<div class="zwssgr-slider-8 swiper">
							<div class="swiper-wrapper">
								' . (($zwssgr_post_count > 0) ? $zwssgr_slider_content8  : '<p class="zwssgr-no-found-message">'.esc_html__('No reviews found for the selected ratings', 'smart-showcase-for-google-reviews').'</p>') . '
							</div>
						</div>
						<div class="swiper-button-next zwssgr-swiper-button-next"></div>
						<div class="swiper-button-prev zwssgr-swiper-button-prev"></div>
				...
				'grid' => [
					...
					'<div class="zwssgr-slider zwssgr-grid-item zwssgr-grid6" id="zwssgr-grid6">
						' . (($zwssgr_post_count > 0) ? $zwssgr_grid_content6  : '<p class="zwssgr-no-found-message">'.esc_html__('No reviews found for the selected ratings', 'smart-showcase-for-google-reviews').'</p>') . '
					</div>',
					'<div class="zwssgr-slider zwssgr-grid-item zwssgr-grid7" id="zwssgr-grid7">
						' . (($zwssgr_post_count > 0) ? $zwssgr_grid_content7  : '<p class="zwssgr-no-found-message">'.esc_html__('No reviews found for the selected ratings', 'smart-showcase-for-google-reviews').'</p>') . '
					</div>'
				],
				'list' => [
					...
					'<div class="zwssgr-slider zwssgr-list zwssgr-list6" id="zwssgr-list6">
						' . (($zwssgr_post_count > 0) ? $zwssgr_list_content6  : '<p class="zwssgr-no-found-message">'.esc_html__('No reviews found for the selected ratings', 'smart-showcase-for-google-reviews').'</p>') . '
					</div>',
					'<div class="zwssgr-slider zwssgr-list zwssgr-list7" id="zwssgr-list7">
						' . (($zwssgr_post_count > 0) ? $zwssgr_list_content7  : '<p class="zwssgr-no-found-message">'.esc_html__('No reviews found for the selected ratings', 'smart-showcase-for-google-reviews').'</p>') . '
					</div>'
		...
		function zwssgr_generate_shortcode($zwssgr_post_id) {
			...
			if ($zwssgr_current_tab2 === 'tab-selected' && $zwssgr_current_tab === 'tab-options') {
				...
				$zwssgr_shortcode = sprintf(
					'[zwssgr_widget post-id="%d" layout="%s" layout-option="%s"]',
					$zwssgr_post_id,
		...
		function zwssgr_filter_reviews_ajax_handler() {
			...
			if ($zwssgr_reviews_query->have_posts()) {
				while ($zwssgr_reviews_query->have_posts()) {
					...
					$zwssgr_slider_item1 = '
						<div class="zwssgr-slide-item swiper-slide">
							<div class="zwssgr-list-inner">
								...
								' . (!empty($zwssgr_stars_html) ? '<div class="zwssgr-rating">' . $zwssgr_stars_html . '</div>' : '') . '
								' . ( !empty($zwssgr_trimmed_content) ? '<p class="zwssgr-content">' . esc_html($zwssgr_trimmed_content) . ($zwssgr_is_trimmed ? ' <a class="toggle-content zwssgr-toggle-content" data-full-text="' . esc_attr($zwssgr_review_content) . '">' . esc_html($this->zwssgr_translate_read_more($zwssgr_language)) . '</a>' : '') . '</p>' : '' ) . '
							</div>
						</div>';
					...
					$zwssgr_slider_item8 = '
						<div class="zwssgr-slide-item swiper-slide">
							<div class="zwssgr-list-inner">
								' . (!empty($zwssgr_stars_html) ? '<div class="zwssgr-rating">' . $zwssgr_stars_html . '</div>' : '') . '' . ( !empty($zwssgr_trimmed_content) ? '<p class="zwssgr-content">' . esc_html($zwssgr_trimmed_content) . ($zwssgr_is_trimmed ? ' <a class="toggle-content zwssgr-toggle-content" data-full-text="' . esc_attr($zwssgr_review_content) . '">' . esc_html($this->zwssgr_translate_read_more($zwssgr_language)) . '</a>' : '') . '</p>' : '' ) . '	
								<div class="zwssgr-slide-wrap4 zwssgr-slider-wrap8">
									<div class="zwssgr-profile">
										'.(file_exists($zwssgr_gmb_reviewer_image_path) ? '<img src="' . esc_url($zwssgr_gmb_reviewer_image_uri) . '" class="fallback-user-dp" alt="'. esc_html($zwssgr_reviewer_name).'">' : '<img src="' . $zwssgr_plugin_dir_path . 'assets/images/fallback-user-dp.png" alt="'. esc_html($zwssgr_reviewer_name).'">').'
										<div class="zwssgr-google-icon">
			...
			$zwssgr_filter_layout = [
				...
				'grid' => [
					...
					'<div class="zwssgr-slider zwssgr-grid-item zwssgr-grid6" id="zwssgr-grid6">
						' . $zwssgr_grid_content6 . '
					</div>',
					'<div class="zwssgr-slider zwssgr-grid-item zwssgr-grid7" id="zwssgr-grid7">
						' . $zwssgr_grid_content7 . '
					</div>'
				],
				'list' => [
					'<div class="zwssgr-slider zwssgr-list zwssgr-list1" id="zwssgr-list1">
