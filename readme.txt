...
= 1.0.8 =
* Google Review Filtering: Added automatic filtering of new Google Reviews based on matching keywords, allowing relevant reviews to be automatically added to the appropriate widget.
...
= 1.0.4 =
* Updated tooltip content for improved clarity
* Resolved various bugs

= 1.0.3 =
* Enhanced data processing and CRON functionality
* Added widget creation feature
* Fixed bugs and resolved PHPCS issues
