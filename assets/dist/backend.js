...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (zwgrDashboard) {
    zwgrDashboard.addEventListener('click', function (zwssgrEv) {
      ...
      document.querySelectorAll('.zwssgr-date-range-picker').forEach(function (zwssgrDateInput) {
        zwssgrDateInput.classList.remove('active');
        var zwssgrFlatpickrInstance = zwssgrDateInput._flatpickr;
...
function zwssgr_draw_chart(zwssgrChartData) {
  ...
  var zwssgrChartLegendWrapper = document.getElementById('zwsr_chart_legend_wrapper');
  var zwssgrOuterWrapper = document.querySelector(".zwssgr-outer-wrapper");
...
/***/ "./assets/src/js/backend/widget-reviews-filter.js":
/*!********************************************************!*\
  !*** ./assets/src/js/backend/widget-reviews-filter.js ***!
  \********************************************************/
/***/ (() => {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var zwssgrSelectIds = ['zwssgr-account-select', 'zwssgr-location-select'];
  zwssgrSelectIds.forEach(function (zwssgrId) {
    var zwssgrElement = document.getElementById(zwssgrId);
    if (zwssgrElement) {
      zwssgrElement.addEventListener('change', function () {
        var zwssgrForm = document.getElementById('posts-filter');
